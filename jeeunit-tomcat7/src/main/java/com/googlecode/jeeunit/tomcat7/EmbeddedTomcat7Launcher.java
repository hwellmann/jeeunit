 ...
 *
 */
public class EmbeddedTomcat7Launcher extends DelegatingContainerLauncher<EmbeddedTomcat7Container> {
    
    @Override
    public synchronized EmbeddedTomcat7Container getSingleton() {
        return EmbeddedTomcat7Container.getInstance();
    }
}
